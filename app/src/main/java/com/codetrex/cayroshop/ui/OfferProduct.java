...
public class ProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     private void getCategoryWiseProduct()
     {
         ...
         StringRequest request = new StringRequest(Request.Method.POST, Api.ALL_CATEGORY_WISE_PRODUCT+cat_id, new Response.Listener<String>() {
             @Override
             public void onResponse(String response) {
                 ...
                 try {
                     ...
                     CategoryProductAdapter productAdapter=new CategoryProductAdapter(productItemModels,ProductActivity.this);
                     product_recyclerview.setAdapter(productAdapter);
                     productAdapter.notifyDataSetChanged();
                     progressBar.setVisibility(View.GONE);

                 }catch (Exception e){
                     Toast.makeText(ProductActivity.this, "Somthing Went Wrong"+e.getMessage(), Toast.LENGTH_SHORT).show();
                     progressBar.setVisibility(View.VISIBLE);
                 }
    ...
    private void showCityList()
    {
        ...
        Window window = ProductActivity.this.getWindow();
        window.getDecorView().getWindowVisibleDisplayFrame(displayRectangle);
        final AlertDialog.Builder builder = new AlertDialog.Builder(ProductActivity.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(ProductActivity.this).inflate(R.layout.filter_layout, viewGroup, false);
